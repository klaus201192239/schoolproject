...
public class ChangeUserSchool extends Activity {

	private String mypro,mycity;
	private Intent intent;
	private int sex, degree, grade;
	@SuppressWarnings("unused")
	private String phone, pwd, majorname, name, schoolname, email, studentid,majorid, schoolid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_change_user_school);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.change_user_school, menu);
		return true;
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent intent = new Intent(ChangeUserSchool.this,ChangeUserInfo.class);
	...
	public void intiView() {
		lv = (ListView) findViewById(R.id.changinfo_school_nameList);
		...
		changecity=(Spinner)findViewById(R.id.chsc_city);
		changepro=(Spinner)findViewById(R.id.chsc_pro);
		...
		changepro.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				...
				try{
					...
					adaptercity = new ArrayAdapter<String>(ChangeUserSchool.this,android.R.layout.simple_spinner_item, objcity);
	...
	public void intiData() {
		...
		progressDialog = ProgressDialog.show(ChangeUserSchool.this, "",
				"正在查询,请稍候！");
	...
	public void btonclik(View v) {
		int vid = v.getId();
		if (vid == R.id.changinfo_school_giveup) {
			Intent intent = new Intent(ChangeUserSchool.this,ChangeUserInfo.class);
			intent.putExtra("from", "016");
			startActivity(intent);
			finish();
			...
			progressDialog = ProgressDialog.show(ChangeUserSchool.this, "","正在查询,请稍候！");
			...
			new Thread() {
				public void run() {
					...
					System.out.println("HAHA"+httpjson);
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message message) {
			...
			case 3:
				...
				adapterpro = new ArrayAdapter<String>(ChangeUserSchool.this,android.R.layout.simple_spinner_item, objpro);
	...
	public void pagejump(Map<String, String> mapmap) {
		...
		Intent intenta = new Intent(ChangeUserSchool.this, ChangeUserInfo.class);
